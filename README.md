...
* **Chair** was the best-selling product, recording:
  ...
  * **562 units sold**
  * **₦195,620.11** in revenue
* **FreeShip** was the most frequently used coupon code.
* **2023** recorded the highest sales performance with:
...
* **2025** generated the highest revenue of **₦56,086.69**.
* Sales showed a **fluctuating trend** over the analysis period.
* **Order ORD200789** recorded the highest order value of **₦3,456.40**.
* **Phone** had the highest average selling price (**₦375.22**), while **Chair** had the lowest average selling price (**₦355.xx**).
* **Credit Card** payments generated the highest revenue (**₦263,847.63**), narrowly outperforming **Online** payments (**₦262,447.94**).
...
* **Chair** generated the highest sales volume despite having one of the lowest average selling prices, suggesting that its strong performance is driven by **high customer demand rather than premium pricing**.
* **Phone** commands the highest average selling price but sells fewer units, indicating that higher prices do not necessarily translate into higher sales volume.
* The high number of **cancelled orders** represents a significant loss of potential revenue and should be investigated to identify the underlying causes.
* Although **Online** was the most frequently used payment method, **Credit Card** transactions generated slightly more revenue, indicating that customers paying by credit card tend to place higher-value orders.
* **Instagram** proved to be the most effective referral channel for revenue generation, making it a strong candidate for increased marketing investment.
